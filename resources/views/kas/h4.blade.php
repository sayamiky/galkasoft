...
<div class="header"> 
    ...
    <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
                <center>
                    <button class="btn btn-default btn-lg"  ><a href="{{route('h3')}}" style="text-decoration: none; color:#000;">3. TANDA TANGAN DAN KIRIM</a> </button>
                </center>
            </div>
            <div class="col-md-3 col-sm-3">
                <center>
                    <button class="btn btn-default btn-lg"  ><a href="{{route('h4')}}" style="text-decoration: none; color:#000;">4. AKTIVASI</a> </button>
                </center>
            </div>
        </div><br><br> 
